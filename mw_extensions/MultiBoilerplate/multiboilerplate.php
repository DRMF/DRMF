 ...
 * @copyright Copyright Â© 2007 - 2009 Robert Leverington.
 * @copyright Copyright Â© 2009 Al Maghi.
...
function efMultiBoilerplate( $form ) {
	...
	global $wgMultiBoilerplateOptions, $wgMultiBoilerplateOverwrite, $wgTitle, $wgRequest, $wgOut;
